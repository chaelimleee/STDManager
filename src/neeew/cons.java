...
//		textArea.setBounds(54, 10, 150, 90);
//		panel_3.add(textArea);
		
//		table_2 = new JTable();
//		table_2.setBounds(12, 10, 767, 275);
//		panel_3.add(table_2,BorderLayout.CENTER);
		...
		panel_4.setBounds(675, 72, 132, 127);
		...
		lblNewLabel_1_2.setBounds(409, 53, 98, 22);
		contentPane.add(lblNewLabel_1_2);
		
		JPanel panel = new JPanel();
		panel.setBounds(339, 60, 335, 127);
		contentPane.add(panel);
		panel.setLayout(null);
		
		JTextArea textArea = new JTextArea();
		textArea.setBounds(54, 10, 281, 117);
		panel.add(textArea);
...
////		return panel_3.add(weekMain());
////	}
//	public void weekMain () {
//		String []weekMain = {"월요일","화요일","수요일","목요일","금요일"};
//		String [][]contents = {
//				{"djWjrn","djWjrn","djWjrn","djWjrn","djWjrn"},
//		};
...
//		table_2.setPreferredScrollableViewportSize(new Dimension(700,600));
...
//		panel_3.add(sc);
//		
//		DefaultTableCellRenderer dtcr = new DefaultTableCellRenderer();//모델 데이터 연결
//		dtcr.setHorizontalAlignment(SwingConstants.CENTER);
